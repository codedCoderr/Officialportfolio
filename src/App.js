        ...
        <Router>
          ...
          <div className='mobile_container'>
            ...
            <div className="social_buttons">
              <a href="https://github.com/codedcoderr" target='_blank' rel="noopener noreferrer"><i className='fab fa-github'></i></a> 
              <a href="https://twitter.com/codedcoder" target='_blank' rel="noopener noreferrer"><i className='fab fa-twitter'></i></a>
          ...
          <div className="container">
            ...
            <div className="main">
              ...
              <div className="pages_container">
                <Route exact path='/' render={props => (<Resume  menu={this.state.menu} activeMenu={this.activeMenu.bind(this)}/>)} />
                <Route exact path='/work' render={props => (<Work  menu={this.state.menu} activeMenu={this.activeMenu.bind(this)}/>)} />
                <Route exact path='/resume' render={props => (<Resume menu={this.state.menu} activeMenu={this.activeMenu.bind(this)} />)} />
                <Route exact path='/contact' render={props => (<Contact menu={this.state.menu} activeMenu={this.activeMenu.bind(this)} />)} />
